...
var ClozeFlashcard = require('./clozure.js');
    ...
    inquirer.prompt([{
        ...
        if (answer.cardType === 'basic-flashcard') {
            ...
            inquirer.prompt([{
                ...
                validate: function(input) {
                    if (input === '') {
                        console.log('Please enter the cloze section');
                        return false;
                    } else {
                        return true;
                    }
                ...
                if (text.includes(cloze)) {
                    ...
                    console.log('The cloze section you provided is accurate. Please try again.');
                    addCard();
                }
            });
        }
